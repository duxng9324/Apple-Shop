...
function OrderAd() {
    ...
    const filteredOrders = filterValue === 'all' ? orders : orders.filter((o) => o.status === filterValue);
    ...
    return (
        <div style={{ padding: 24 }}>
            ...
            {filteredOrders.map((order) => {
                ...
                const isPending = !!pendingByOrderId[order.id];
                            ...
                            >
                                <Space>
                                    ...
                                    <Select
                                        ...
                                        disabled={isPending}
                                        loading={isPending}
                                        onChange={(value) => handleChangeStatus(value, order)}
